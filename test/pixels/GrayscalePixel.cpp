...
#include <utils/GrayscalePixel/Helpers.hpp>
...
BOOST_DATA_TEST_CASE(CopyConstruction, GP_TEST_DATA, pixel_value) {
...
BOOST_DATA_TEST_CASE(CopyAssignment, GP_TEST_DATA, pixel_value) {
  const GrayscalePixel test_pixel_original(pixel_value);
...
BOOST_DATA_TEST_CASE(Getter, GP_TEST_DATA, pixel_value) {
  const GrayscalePixel test_pixel(pixel_value);

  BOOST_CHECK(test_pixel.get_value() == pixel_value);
} // Getter

BOOST_DATA_TEST_CASE(Setter, GP_TEST_DATA, pixel_value) {
...
BOOST_DATA_TEST_CASE(Equal, GP_TEST_DATA, pixel_value) {
...
BOOST_DATA_TEST_CASE(NotEqual, GP_TEST_DATA, pixel_value) {
  const GrayscalePixel lhs(pixel_value);
